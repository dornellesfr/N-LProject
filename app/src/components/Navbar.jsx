    ...
    <nav id="nav-bar" className="sticky top-0 px-2 bg-blue-800">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <Link to="/" className="flex items-center">
          <img src={logo} className="h-6 mr-3 sm:h-10" alt="Empresa Logo" />
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-dropdown">
          ...
          >
            ...
            <li>
              <button label="Dropdown button" type="button" id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" className="flex items-center justify-between w-full py-2 pl-3 pr-4 font-medium text-white rounded hover:bg-blue-600 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:w-auto">
                Mais
                ...
                <div id="dropdownNavbar" className="z-10 hidden font-normal bg-white divide-y divide-white rounded-lg shadow w-44">
                  <ul className="py-2 text-sm text-white" aria-labelledby="dropdownLargeButton">
                    ...
                    <li>
                      <Link to="/about" className="block px-4 py-2 text-blue-600 hover:bg-white">Opção 2</Link>
                    </li>
                    <li>
                      <Link to="/about" className="block px-4 py-2 text-blue-600 hover:bg-white">Opção 3</Link>
                    </li>
                  </ul>
                </div>
              </button>
            ...
            <li>
              <Link to="/clients" className="block py-2 pl-3 pr-4 text-white rounded hover:bg-blue-600 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0">Clientes</Link>
            </li>
            <li>
