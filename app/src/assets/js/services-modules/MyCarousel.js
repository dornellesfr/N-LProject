class MyCarousel {
  ...
  createItems () {
    this.getNCarousel()
    let text = '<div class="relative w-11/12 m-auto my-cont-carousel md:w-8/12" data-carousel="slide"><div class="relative h-60 overflow-hidden rounded-lg md:h-96">'
  ...
  setItemsAndOptions () {
    this.items = []
    this.indicators = []
    this.elementsItems = document.querySelectorAll(`.carousel-${this.number}-item`)
    this.elementsIndicators = document.querySelectorAll(`.carousel-${this.number}-indicator`)

    this.elementsItems.forEach((item, index) => {
      this.items.push({position: index, el: item})
    })

    this.elementsIndicators.forEach((indicator, index) => {
...
const items3 = ['../assets/images/servicos/12.jpg', '../assets/images/servicos/13.jpg', '../assets/images/servicos/16.jpg', '../assets/images/servicos/18.jpg', '../assets/images/servicos/19.jpg', '../assets/images/servicos/22.jpg', '../assets/images/servicos/29.jpg', '../assets/images/servicos/30.jpg', '../assets/images/servicos/34.jpg', '../assets/images/servicos/38.jpg']

const container1 = document.querySelector('#carousel-1')
const container2 = document.querySelector('#carousel-2')
const container3 = document.querySelector('#carousel-3')
...
const carousel3 = new MyCarousel(items3, container3, duration, interval)
carousel1.start()
carousel2.start()
carousel3.start()