  ...
  return (
    <>
      ...
      <main id="service-page-content" className="flex mb-24 flex-col md:mb-96">
        ...
        <Link to="/sobre" id="btn-our-services" className="border-solid border-2 border-white text-white hover:backdrop-blur-sm focus:ring-4 focus:outline-none font-bold rounded-lg text-sm px-20 py-2.5 text-center hover:px-32 mt-10 self-center md:text-3xl md:hover:px-96">Conheça mais sobre a empresa</Link>
      </main>
    </>
  );
}
